...
function Projects() {
    return (
        <div className="projects-container">
            <Project image="Assets/project-images/artjacent.png" projectTitle="ArtJacent" projectDescription="This is a social media app that is directed at local artists and people who are interested in their work. Artists post their work, and the viewer sees them in their feed, sorted by distance to the creator." link="https://github.com/EvanCWoods/artJacent"/>
            <Project image="Assets/project-images/note-taker.png" projectTitle="Note Taker" projectDescription="This is a note taker app that runs in the browser. It is designed to allow a user to create notes throughout the work day, change them as reuired and delete them upon completion." link="https://github.com/EvanCWoods/Note-Taker"/>
