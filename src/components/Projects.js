...
function Projects() {
    return (
        <div className="projects-container">
            ...
            <Project image={cocktails} projectTitle="Cocktail Translator" projectDescription="This app takes user input of a cocktail name, allows them to select the language to translate to, and provides information in both english and the selected language such as a description, ingredients and measurements." link="https://github.com/EvanCWoods/group-3-cocktails-in-any-language"/>
